...
ActiveRecord::Schema[7.1].define(version: 2024_08_06_124752) do
  ...
  create_table "collection_infos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "backup_collection_image"
  end
  ...
  create_table "submissions", force: :cascade do |t|
    ...
    t.index ["board_id"], name: "index_submissions_on_board_id"
  end

  add_foreign_key "submissions", "boards"
end
